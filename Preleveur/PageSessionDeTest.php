...
$req2 = $db->prepare("SELECT a.nom from antibiotique a JOIN session s on s.id_antibiotique=a.id WHERE s.id=:idsession");
$req2->bindParam(":idsession",$idSession);
$req2->execute();
$result2 = $req2->fetch();
echo "<h3> Pour antibiotique : ".$result2['nom']."</h3><br>";
// début affichage
echo "<table class='table'><tr><th>Bactérie (souche) / AntibioPLUS</th>";
